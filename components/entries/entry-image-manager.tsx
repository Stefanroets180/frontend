        ...
        {images.map((image) => {
          ...
          return (
            <Card key={image.id} className="relative group overflow-hidden">
              ...
              {/* Actions overlay */}
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 z-10 md:opacity-0 sm:opacity-100">
                {!image.isLocked && (
                  <>
                    <Button
                      type="button"
